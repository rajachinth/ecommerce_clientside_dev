...
export class ShoppingcartComponent implements OnInit, OnDestroy {
  ...
  animationState = 'animationStateOne';
  categoryList;
  ...
  onclickEvent(event) {
    console.log(event);
    if (this.animationState == 'animationStateOne') { this.animationState = 'animationStateTwo'; } else { this.animationState = 'animationStateOne'; }
  }
  ngOnDestroy(): void {
